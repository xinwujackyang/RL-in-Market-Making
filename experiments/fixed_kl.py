        ...
        trajectory_rows.append(
            {
                ...
                "analytic_kl": diagnostic["analytic_kl"],
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Custom PPO with fixed analytic KL penalty")
    ...
    for seed in range(args.seeds):
        if seed in completed:
            ...
            continue
        print(f"Training fixed-KL seed={seed}", flush=True)
