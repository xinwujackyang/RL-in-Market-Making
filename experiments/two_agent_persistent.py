...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train PPO against a persistent market maker")
    ...
    def env_factory(episode: int):
        return TwoDealerMarketEnv(PersistentMarketMaker(0.5, 0.5, 0.0), cfg, seed=cfg.seed + 1000 + episode)
