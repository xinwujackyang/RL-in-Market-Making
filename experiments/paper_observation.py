...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Paper-aligned observation and market-volatility baseline"
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "results" / "paper_observation",
    )
    ...
    for seed in range(args.seeds):
        if seed in completed:
            ...
            continue
        print(f"Training paper-observation seed={seed}", flush=True)
