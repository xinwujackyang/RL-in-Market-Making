        ...
        trajectory_rows.append(
            {
                ...
                "value_loss_unclipped": diagnostic["value_loss_unclipped"],
                "value_clip_fraction": diagnostic["value_clip_fraction"],
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Custom PPO with squared value-loss clipping")
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "results" / "value_loss_clip",
    )
    ...
    for seed in range(args.seeds):
        if seed in completed:
            ...
            continue
        print(f"Training value-loss-clip seed={seed}", flush=True)
